...
use Red\Red;
    ...
    */
    ...
    |--------------------------------------------------------------------------
    | Supervisor IP
    | Supervisor Can Access Application on Maintenance Break
    |--------------------------------------------------------------------------
    |
    |
    */

    Environment::set('PROJECT', 'SupervisorIP', '192.168.0.1');
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Setting this Value On Will Turn RedFramework Special Encryption System
    | All of Your Post Variables will be Secured
    |
    */

    Environment::set('PROJECT', 'Encryption', 'on');
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Debug Bar is A Development Tool Which Make Coding Easier for you.
    | be Careful with this Option !
    | Use this For Development Mode.
    |
    */

    Environment::set('DEBUG', 'DebugBar', 'on');
